                                                  ...
                                                  <div class="order-detail-grid">
                                                       <div class="row-each-order-detail">
                                                            <div class="order-detail-holder">
                                                                 <div class="order-detail-section recent-detail-image-section">
                                                                      <a href="#">
                                                                 ...
                                                                 <div class="order-detail-section recent-detail-item-section">
                                                                      <span class="tablet-below-col-detail-heading">Item #</span>
                                                                      <span class="order-detail-text item-number-text">18034</span>
                                                                 </div>
                                                                 <div class="order-detail-section recent-detail-description-section">
                                                                 ...
                                                                 <div class="order-detail-section recent-detail-actions-section">
                                                                      <div class="action-button-section-account">
